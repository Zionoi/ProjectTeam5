  ...
  return (
    <div className="comments-section">
      ...
      <div className="comments-actions">
        <button onClick={() => navigate('/write')}  className="letter-button">쪽지 보내기</button>  {/* useNavigate로 경로 이동 */}
      <button onClick={() => navigate('/inbox')} className="letter-button">쪽지함</button>  {/* useNavigate로 경로 이동 */}
